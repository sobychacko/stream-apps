...
import org.springframework.function.app.RabbitSinkConfiguration;
import org.springframework.function.app.RabbitSinkProperties;
...
public abstract class RabbitSinkTests {
	...
	@Autowired
	protected RabbitSinkProperties rabbitSinkProperties;
